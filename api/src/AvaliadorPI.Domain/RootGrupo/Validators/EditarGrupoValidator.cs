...
{
    public class EditarGrupoValidator : AbstractValidator<Grupo>
    {
        private readonly IGrupoRepository _GrupoRepository;

        public EditarGrupoValidator(IGrupoRepository GrupoRepository)
        {
        ...
        private async Task<bool> NomeGrupoUnico(Grupo grupo, string nome, CancellationToken token)
        {
            return !await _GrupoRepository.AnyAsync(x => x.Nome == nome && x.Id != grupo.Id);
        }
    }
}
